            ...
            <div class="menus">
                <div class="menu">
                    ...
                    <nav>
                        ...
                        <?php }?>
                        <!-- <a href="#" <?php if ($menu == 'dicas'){ ?> class="select" <?php } ?>><img src="../assets/img/diario/Dicas<?php if ($menu == 'dicas'){ echo "-select";}?>.png" alt="Foto do Dicas"> Dicas</a> -->
                        <!-- <a href="#"><img src="../assets/img/diario/saude.png" alt="Foto do Saúde"> Saúde</a> -->
