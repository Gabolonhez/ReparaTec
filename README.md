...
`Cadastro e acesso dos usuários`: Permite os usuários cadastrar e acessar a plataforma (técnico ou empresa).
`Abertura, busca, agendamento`: listagem, encerramento e avaliação de solicitações de serviços.
